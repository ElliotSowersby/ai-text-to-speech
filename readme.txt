...
Easily generate and display an audio version for your posts using OpenAI's TTS API.

== Description ==

A simple plugin that allows you to generate an audio version of your posts using OpenAI's TTS API.
...
1. Example of TTS generator on posts page.
2. Example of TTS plugin settings.
