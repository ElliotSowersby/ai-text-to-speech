        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <table class="form-table">
                    ...
                    <tr valign="top">
                        <th scope="row"><?php echo esc_html__('Player Background Color', 'ai-text-to-speech'); ?></th>
                        <td>
                            <input type="color" name="ai_tts_settings[player_background_color]"
                            placeholder="#f1f1f1"
                            value="<?php echo esc_attr(ai_tts_get_option('player_background_color')); ?>" />
                        </td>
                    </tr>
                </table>
